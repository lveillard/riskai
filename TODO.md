...
- [ ] Suavizar la silueta geométrica de las costas importadas; la ronda cambia materiales y conserva geometría/navegación fuente.
...
- [ ] Ejecutar comparación limpia 500/1000/2000 durante 90 s y confirmar el candidato en partida avanzada. Dos preparaciones avanzadas no lograron crear la cohorte del jugador cero; distinguir pérdida de ciudades de ausencia de puntos navegables antes de repetir. El presupuesto permanece en 500 hasta disponer de evidencia sin compiladores externos.
...
- [ ] Costa más natural: v0.22 completa clasificación compartida de arena/roca, pruebas de GPU, nuevos materiales y agua somera. Se conserva UV1 y se registra el bake en `StartupMetrics`/fase `terrain`. Sigue pendiente suavizar la silueta geométrica importada sin contradecir navegación, islas o muelles.
