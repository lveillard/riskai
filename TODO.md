...
aprobado 94 casos Unity distintos; exportaciones y evidencia del último parche
se cierran por separado.

- [x] Corregir arrastre derecho en pausa, conservar rueda de cámara y cancelar gestos pendientes al pausar/reanudar. Regresión Unity aprobada; exportación final pendiente.
...
- [ ] Mostrar iconos de fragata y transporte en compras y colas. Mantener la explicación sólo en tooltip por hover; el texto permanente se rechaza y la ayuda por pulsación larga queda para fase 2. Catálogo y colas verificados en Windows a 1600×900 y ventana compacta 390×844 del commit `060ed60`; falta la exportación final del parche posterior.
- [ ] Un solo defensor y propietario por puerto; el barco guardián habilita producción mediante los mismos comandos que el resto. Se conserva la prioridad de un guardián vivo y las anclas duales; escaneo `Contested`, prioridad terrestre viva y sucesión naval aprobados en Unity.
...
- [ ] Ampliar ligeramente el margen de relevo de guarnición, especialmente para caballeros; misma tolerancia terrestre y naval (2,0 frente a radio pintado 1,55). La prueba pasó navegando desde más de 5 m; no fue necesario ampliar el radio naval.
