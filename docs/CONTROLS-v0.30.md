...
- The top bar is a single row of icon+number items (gold and income, next-income countdown, cities, recruited units out of 100, Map, Menu). Long-press an item for details.
