...
namespace RiskAI
{
    ...
    public static class GameText
    {
        ...
        static readonly KeyValuePair<string,string>[] Phrases = {
            ...
            Pair("Con una tropa ocupada añade la orden: mover, atacar, capturar, seguir, embarcar y desembarcar. Sin Mayús, la orden sustituye la cola. La ruta se ve con Mayús o Encolar; si no, aparece 1,2 s y se desvanece. El conmutador de la barra rápida hace lo mismo.",
                "With a busy unit, add the order: move, attack, capture, follow, board and unload. Without Shift the order replaces the queue. The route shows while Shift or Queue is on; otherwise it appears for 1.2 s and fades. The quick-bar switch does the same."),
