    ...
    public static class RtsSkin
    {
        ...
        public static void Initialize()
        {
            ...
            for(int team=0;team<townLabels.Length;team++)
                townLabels[team]=new GUIStyle(Center){fontSize=10,wordWrap=false,clipping=TextClipping.Clip,normal={textColor=Color.Lerp(VisualFactory.TeamColor(team),Color.white,.55f)}};
