...
namespace RiskAI.Core
{
    ...
    public static class BattleRules
    {
        ...
        static readonly string[] Names = { "Espadach\u00edn", "Ballestero", "Caballero", "Mago", "Mortero", "Sanador", "Marine Private", "Marine Major", "Marine General" }, Roles = { "Primera l\u00ednea", "Ataque a distancia", "Caballer\u00eda pesada", "Da\u00f1o de \u00e1rea", "\u00c1rea a larga distancia", "Sana aliados \u00b7 25 vida", "Fusilero de puerto", "Caballer\u00eda de puerto", "Caballer\u00eda veterana de puerto" }, Keys = { "Q", "W", "D", "F", "R", "C", "V", "B", "C" }, Models = { "Knight", "RogueHooded", "RoyalGuard", "Mage", "Mortar", "Medic", "RogueHooded", "RoyalGuard", "RoyalGuard" };
