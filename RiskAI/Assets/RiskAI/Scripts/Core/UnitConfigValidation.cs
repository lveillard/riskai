    ...
    public static class UnitConfigValidation
    {
        public static List<string> Errors(UnitsFile file)
        {
            ...
            foreach (var unit in file.Units)
            {
                ...
                if ((unit.Domain == UnitDomain.Sea && !(((unit.Presentation != null && unit.Presentation.PortraitFraming == PortraitFraming.Frigate) || ((unit.Presentation != null && unit.Presentation.PortraitFraming == PortraitFraming.Warship) || (unit.Presentation != null && unit.Presentation.PortraitFraming == PortraitFraming.Battleship)))))) errors.Add("" + at + ": a sea portrait uses a hull camera");
                if ((unit.Domain != UnitDomain.Sea && ((unit.Presentation != null && unit.Presentation.PortraitFraming == PortraitFraming.Frigate) || ((unit.Presentation != null && unit.Presentation.PortraitFraming == PortraitFraming.Warship) || (unit.Presentation != null && unit.Presentation.PortraitFraming == PortraitFraming.Battleship))))) errors.Add("" + at + ": a hull camera is only for a sea unit");
