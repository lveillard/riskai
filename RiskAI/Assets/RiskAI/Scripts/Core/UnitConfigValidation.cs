    ...
    public static class UnitConfigValidation
    {
        public static List<string> Errors(UnitsFile file)
        {
            ...
            foreach (var unit in file.Units)
            {
                ...
                if (((unit.Presentation != null && unit.Presentation.PortraitCamera != null && (unit.Presentation.PortraitCamera.LandDefault == true)) && unit.Domain != UnitDomain.Land)) errors.Add("" + at + ": the shared land camera belongs to one land unit");
