...
namespace RiskAI.Core
{
    ...
    public readonly struct PlayerBuildingIntent
    {
        ...
        PlayerBuildingIntent(BuildingId buildingId,PlayerBuildingIntentKind kind,UnitKind unit,int cancelIndex,float rallyX,float rallyY,float rallyZ)
        { BuildingId=buildingId;Kind=kind;Unit=unit;CancelIndex=cancelIndex;RallyX=rallyX;RallyY=rallyY;RallyZ=rallyZ; }

        public static PlayerBuildingIntent Recruit(BuildingId buildingId,UnitKind kind) =>
            new PlayerBuildingIntent(buildingId,PlayerBuildingIntentKind.Recruit,kind,0,0,0,0);
        public static PlayerBuildingIntent CancelTraining(BuildingId buildingId,int index) =>
            new PlayerBuildingIntent(buildingId,PlayerBuildingIntentKind.CancelTraining,default,index,0,0,0);
        public static PlayerBuildingIntent SetRally(BuildingId buildingId,float x,float y,float z) =>
            new PlayerBuildingIntent(buildingId,PlayerBuildingIntentKind.SetRally,default,0,x,y,z);
        public static PlayerBuildingIntent ClearRally(BuildingId buildingId) =>
            new PlayerBuildingIntent(buildingId,PlayerBuildingIntentKind.ClearRally,default,0,0,0,0);
    }
}
