...
namespace RiskAI
{
    ...
    public static class UnitTeamColor
    {
        ...
        static float HueWidth(UnitKind kind) => (kind==UnitKind.Mage||kind==UnitKind.Medic||kind==UnitKind.Roarer)?.16f:(kind==UnitKind.Archer||kind==UnitKind.MarinePrivate||kind==UnitKind.EliteRifleman)?.14f:.085f;
