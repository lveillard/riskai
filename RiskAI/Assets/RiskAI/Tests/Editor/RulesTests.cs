...
namespace RiskAI.Tests
{
    public sealed class RulesTests
    {
        ...
        {
            var economy=new Economy();Assert.That(economy.Advance(59.9f),Is.Zero);Assert.That(economy.Gold[0],Is.EqualTo(4));
            Assert.That(economy.Advance(.2f),Is.EqualTo(1));Assert.That(economy.Gold[0],Is.EqualTo(8));
            Assert.That(economy.Advance(120),Is.EqualTo(2));Assert.That(economy.Round,Is.EqualTo(4));
            Assert.That(economy.Gold[1],Is.EqualTo(16));
        }
