...
namespace RiskAI.Tests
{
    public sealed class ProductionCatalogTests
    {
        ...
        {
            CollectionAssert.AreEqual(new[]{UnitKind.Footman,UnitKind.Archer,UnitKind.Guard,UnitKind.Mage,UnitKind.Mortar,UnitKind.Medic,
            ...
            CollectionAssert.AreEqual(new[]{NavalUnitKind.Galley,NavalUnitKind.Transport,NavalUnitKind.Warship,NavalUnitKind.Battleship,NavalUnitKind.ArmoredTransport},ProductionCatalog.HarborShips);
        ...
        {
            var city=ProductionCatalog.SettlementUnits.Select(BattleRules.Hotkey).ToList();
            CollectionAssert.AllItemsAreUnique(city);
            var harbor=ProductionCatalog.HarborUnits.Select(BattleRules.Hotkey)
