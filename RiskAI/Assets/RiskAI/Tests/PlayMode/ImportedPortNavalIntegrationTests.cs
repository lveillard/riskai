    ...
    public sealed class ImportedPortNavalIntegrationTests
    {
        ...
        public IEnumerator EuropeLinkedPortRecruitsMarinesAndUsesCatalogCaptureCapabilities()
        {
            ...
            try
            {
                ...
                var frigate=BattleTestScenario.Ship(battle.Naval,0,UnitKind.Frigate,target.Port.Berth);
                target.SimTick(.1f);
                ...
                var transport=BattleTestScenario.Ship(battle.Naval,0,UnitKind.Transport,target.Port.Berth);
                target.SimTick(.1f);
