    ...
    public sealed class NavalDockingOrderTests
    {
        ...
        public IEnumerator ExplicitDockingSnapsOnlyOnClaimAndPersistsFromFarAwayInClassicAndEurope()
        {
            foreach (var map in new[] { ScenarioMap.Classic, ScenarioMap.Europe })
            {
                ...
                var ship = BattleTestScenario.Ship(naval, 0, UnitKind.Frigate, near);
                Tick(port);
                ...
                var arriving = BattleTestScenario.Ship(naval, 0, UnitKind.Frigate, far);
        ...
        public IEnumerator StopNewMoveAndDeathCancelPendingDockingAndAlliedSuccessorStillWins()
        {
            ...
            var ally = BattleTestScenario.Ship(naval, 1, UnitKind.Frigate, allyPoint);
            Tick(port);
