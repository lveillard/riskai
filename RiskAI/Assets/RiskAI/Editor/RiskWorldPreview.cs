    ...
    public static class RiskWorldPreview
    {
        ...
        public static void Capture()
        {
            ...
            try
            {
                ...
                Render(camera, output, "Screenshots/v12-world-overview.png");
                ...
                Render(camera, output, "Screenshots/v12-world-bastion.png");
                ...
                Render(camera,output,"Screenshots/v12-world-highlands.png");
                ...
                Render(camera,output,"Screenshots/v12-world-tower.png");
                ...
                Render(camera,output,"Screenshots/v12-world-estuary.png");
                Debug.Log("RISKAI_WORLD_PREVIEW_OK: Screenshots/v12-world-overview.png, Screenshots/v12-world-bastion.png");
            }
